...
set(Wireshark_MINOR_VERSION 1)
set(Wireshark_PATCH_VERSION 0)
set(Wireshark_VERSION "3.1.0")
...
set_and_check(Wireshark_LIB_DIR            "${PACKAGE_PREFIX_DIR}/.")
set_and_check(Wireshark_INCLUDE_DIR        "${PACKAGE_PREFIX_DIR}/include/wireshark")
if(Wireshark_PLUGINS_ENABLED)
    set_and_check(Wireshark_PLUGIN_INSTALL_DIR "${PACKAGE_PREFIX_DIR}/plugins/3.1")
endif()
set_and_check(Wireshark_EXTCAP_INSTALL_DIR "${PACKAGE_PREFIX_DIR}/extcap")
