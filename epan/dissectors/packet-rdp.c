...
/* DvcDataPDU*/
static int hf_rdp_cmd = -1;
static int hf_rdp_sp = -1;
static int hf_rdp_cbChId = -1;
static int hf_rdp_channelId = -1;
...
static int hf_rdp_infoType = -1;
static int hf_rdp_infoType_Logon = -1;
static int hf_rdp_infoType_LogonLong = -1;
static int hf_rdp_infoType_LogonPlainNotify = -1;
static int hf_rdp_infoType_LogonExtendedInfo = -1;
...
dissect_rdp_shareDataHeader(tvbuff_t *tvb, int offset, packet_info *pinfo, proto_tree *tree) {
  ...
  rdp_field_info_t saveSessionInfo_fields[] = {
    { &hf_rdp_infoType, 4, &infoType, 0, 0, NULL },
    FI_TERMINATOR
  };
...
static const value_string info_type_vals[] = {
  { INFOTYPE_LOGON,          "Logon Info Version 1" },
  { INFOTYPE_LOGON_LONG,          "Logon Info Version 2" },
  { INFOTYPE_LOGON_PLAINNOTIFY,      "Plain Notify" },
  { INFOTYPE_LOGON_EXTENDED_INFO, "Logon Info Extended" },
};
...
dissect_rdp_SendData(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void* data _U_) {
  ...
  //rdp_field_info_t dvcdatapdu_fields[] = {
  //  { &hf_rdp_cmd,        2, NULL, 0, 0, NULL },
  //  { &hf_rdp_sp,        2, NULL, 0, 0, NULL },
  //  { &hf_rdp_cbChId,          2, NULL, 0, 0, NULL },
  //  { &hf_rdp_channelId,          2, NULL, 0, 0, NULL },
  //  FI_TERMINATOR
  //};
...
proto_register_rdp(void) {
  ...
  static hf_register_info hf[] = {
    ...
    { "channelId", "rdp.channelId",
        ...
        NULL, HFILL } },
    { &hf_rdp_infoType,
    { "infoType", "rdp.infoType",
      FT_UINT32, BASE_HEX, NULL, 0,
      NULL, HFILL } },
    { &hf_rdp_infoType_Logon ,
    { "infoType", "rdp.infoType.Logon",
      FT_UINT32, BASE_HEX, NULL, 0,
      NULL, HFILL } },
    { &hf_rdp_infoType_LogonLong,
    { "infoType", "rdp.infoType.LogonLong",
      FT_UINT32, BASE_HEX, NULL, 0,
      NULL, HFILL } },
    { &hf_rdp_infoType_LogonPlainNotify,
    { "infoType", "rdp.infoType.LogonPlainNotify",
      FT_UINT32, BASE_HEX, NULL, 0,
      NULL, HFILL } },
    { &hf_rdp_infoType_LogonExtendedInfo,
    { "infoType", "rdp.infoType.LogonExtendedInfo",
      FT_UINT32, BASE_HEX, NULL, 0,
      NULL, HFILL } },
  };
